    ...
    <main className="min-h-screen bg-stone-50 text-slate-900">
      ...
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-16 lg:grid-cols-2 lg:px-8 lg:py-24">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Phytocliniq turns scattered botanical research into structured ingredient briefs and comparison reports so scientific, formulation, and product teams can move faster with more clarity.
          </p>
      ...
      <section id="product" className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-slate-600">
            Phytocliniq is not a consumer wellness chatbot. It is a structured internal workflow for evaluating botanical ingredients before deeper formulation, positioning, and product development decisions move forward.
          </p>
        </div>
          ...
          {[
            {
              ...
              text: "Generate structured internal briefs with evidence summary, safety context, formulation notes, positioning notes, and recommendation state.",
            },
            {
            ...
            },
            {
              ...
              text: "Apply a fixed evaluation lens across evidence strength, ingredient definition, safety context, formulation practicality, and positioning readiness.",
            },
          ].map((item) => (
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 text-slate-600">
                A premium internal decision brief designed for product meetings — clear recommendation, clear scorecard, and concise sections that support faster ingredient review.
              </p>
            </div>
      ...
      <section id="pricing" className="mx-auto max-w-7xl px-6 py-10 lg:px-8 lg:py-16">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-lg text-slate-600">
            Simple pricing for early access, pilot testing, and founder-led onboarding.
          </p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          {[
            ...
            [
              ...
              "No. It is intended to support internal product evaluation, not to replace formal regulatory, legal, or quality review.",
            ],
            [
            ...
            [
              ...
              "Ingredient briefs, comparison reports, and a repeatable scoring workflow for internal decision-making.",
            ],
          ].map(([q, a]) => (
          ...
          <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
                Bring more clarity to botanical ingredient decisions.
              </h2>
